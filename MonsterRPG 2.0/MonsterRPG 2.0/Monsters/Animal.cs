...
namespace MonsterRPG_2._0.Monsters
{
    internal class Animal : Monster
    {
        ...
        public override CreatureTypeEnum CreatureType => CreatureTypeEnum.Animal;
        ...
        public override string GetDamageDoneInfo(int damage, int bonusDamage, CreatureTypeEnum monsterType)
        {
            ...
            else if (bonusDamage > 4 && monsterType != CreatureTypeEnum.Construct && monsterType != CreatureTypeEnum.Ghost)
            {
        ...
        {
            if (damage == 0 && CurrentHP < (MaxHP * 0.35))
            {
        ...
        public override bool IsEvade()
        {
            ...
            if (CurrentHP < (MaxHP * 0.35) && dodjeChance <= 50)
            {
                return true;
            }
